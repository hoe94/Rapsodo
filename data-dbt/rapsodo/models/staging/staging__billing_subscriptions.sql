...
SELECT
	...
	, base.current_period_start::timestamp AT TIME ZONE 'MYT' AS current_period_start_timestamp -- rename_column
	, base.current_period_end::timestamp AT TIME ZONE 'MYT' AS current_period_end_timestamp -- rename_column
	, COALESCE(base.canceled_at::timestamp AT TIME ZONE 'MYT', '9999-12-30 16:00:00') AS canceled_at_timestamp -- fill_null_values rename_column
    , CASE
...
FROM raw_rapsodo.billing_subscriptions base
